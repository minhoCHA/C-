...
int main()
{
 ...
 outputFile << floor << endl;
 outputFile << room << endl;
 outputFile << occupied_room << endl;
 outputFile << total_room << endl;
 outputFile << total_occupied_room << endl;
 outputFile << vacant_room << endl;
 outputFile << occupancy_rate << endl;
